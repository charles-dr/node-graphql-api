...
// const x509 = require('@fidm/x509'); // x509.parseCert is not a function
// const x509 = require("@peculiar/x509"); //x509.parseCert is not a function
...
function fromPfx(params, callback) {
    ...
    function attributes(cb) {
        ...
        child_process.exec(command, function(err, stdout, stderr) {
            ...
            // console.log('[Before x509 Parse]', stdout);
